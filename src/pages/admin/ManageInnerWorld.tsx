...
import { Plus, Trash2, Edit2, X, Upload, Image as ImageIcon, Loader2, Map, Sparkles } from 'lucide-react';
            ...
            <div className="space-y-3">
              <div>
                ...
                <div className="flex items-center gap-2 mt-2">
                  ...
                  <button onClick={generateImage} disabled={generating || uploading} className="btn-grimoire flex items-center gap-1.5 text-xs !py-1 !px-3">
